...
summary_path = "./logs/standard/Sampled_ImageNet_200x1000_50x100_Seed_6/summary_in_ResNet50.log"
...
select_df = summary_df[
    summary_df["model"].isin(["ResNet50", "BasicQuantResNet50V4"])
][
...
).to_excel("ResNet50_Analysis.xlsx")
