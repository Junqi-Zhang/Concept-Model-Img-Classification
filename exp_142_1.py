...
seed_task_elements = {
    ...
    "image_low_concept_max_smoothing": 0.2,
    "contrastive_dim": 512,
    "loss_low_sparsity_weight": 0,
    "loss_low_sparsity_adaptive": False,
    "loss_low_diversity_weight": 1.0,
...
def generate_tasks(seed_task_elements, parallel, gpus):
    ...
    # task 2
    new_task_element = seed_task_elements.copy()
    new_task_element["image_low_concept_max_smoothing"] = 0.3
    tasks.append(new_task_element)

    # task 3
    new_task_element = seed_task_elements.copy()
    new_task_element["image_low_concept_max_smoothing"] = 0.4
    tasks.append(new_task_element)

    # task 4
    new_task_element = seed_task_elements.copy()
    new_task_element["image_low_concept_max_smoothing"] = 0.5
    tasks.append(new_task_element)
