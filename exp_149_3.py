...
seed_task_elements = {
    ...
    "patch_low_concept_num_heads": 64,
    "patch_low_concept_max_function": "hard_gumbel",
...
def generate_tasks(seed_task_elements, parallel, gpus):
    ...
    # task 2
    new_task_element = seed_task_elements.copy()
    new_task_element["image_patch_num_heads"] = 64
    new_task_element["image_patch_max_function"] = "hard_gumbel"
    tasks.append(new_task_element)
