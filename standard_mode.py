...
parser.add_argument("--detach_text_embeds", default="False")
...
parser.add_argument("--preset_hierarchy", default="False")
...
args.preset_hierarchy = eval(args.preset_hierarchy)
